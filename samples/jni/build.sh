...
javac -d bin/ src/cz/adamh/NativeUtils.java src/com/amrayn/residue/Residue.java src/com/amrayn/residue/Logger.java src/com/amrayn/residue/ResiduePrintStream.java
cd bin/
