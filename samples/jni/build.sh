...
javac -d bin/ src/cz/adamh/NativeUtils.java src/org/zuhd/residue/Residue.java src/org/zuhd/residue/Logger.java src/org/zuhd/residue/ResiduePrintStream.java
cd bin/
